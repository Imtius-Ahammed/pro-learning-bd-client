  ...
  return (
    <div className="navbar mb-8  lg:text-2xl text-white bg-base-300 lg:px-40">
      ...
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal rounded-xl shadow-md shadow-info">
          <li>
            <Link to="/">Home</Link>
          </li>
          <li>
        ...
        {user?.uid ? (
          <div className="flex items-center">
            ...
            <button
              ...
              className="btn shadow-md shadow-success bg-black hover:bg-green-200 text-white hover:text-black font-bold my-2"
            >
              Log Out
            </button>
          </div>
